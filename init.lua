...
dofile(minetest.get_modpath("foxmobs").."/api.lua")
--dofile(minetest.get_modpath("foxmobs").."/bones.lua")
--dofile(minetest.get_modpath("foxmobs").."/stuff.lua")

foxmobs = {}
--REFERENCE

--function (mod_name_here):spawn_specific(name, nodes, neighbors, min_light, max_light, interval, chance, active_object_count, min_height, max_height)
bp:register_spawn("foxmobs:Trails", {"default:dirt_with_grass","default:stone", "default:stonebrick","default:cobble"}, 20, -1, 400000, 1, 31000)
...
--Spawn eggs
bp:register_egg("foxmobs:Trails", "Tails", "spawn_egg_tails.png")
...
bp.npc_drops = { "default:pick_steel", "foxmobs:meat", "default:sword_steel", "default:shovel_steel", "farming:bread 5", "default:wood", "foxmobs:leather", "foxmobs:carrotstick" }--Added 20151121


-------------------------
--GOOD NPC'S
-------------------------
bp:register_mob("foxmobs:Trails", {
	type = "npc",
	hp_min = 25,
	hp_max = 35,
	...
	light_damage = 0,
		...
		local_chat(clicker:getpos(),"Trails: Let's go make some videos!",3)
...
bp:register_mob("foxmobs:doggie", {
	...
	elseif not self.driver and self.saddle == "yes" then
		self.driver = clicker
		clicker:set_attach(self.object, "", {x = 0, y = 19, z = 0}, {x = 1.5, y = 1.5, z = 1.5})
...
minetest.register_node("foxmobs:bones", {
	description = "Bones",
	tiles = {
		"bones_top.png",
		"bones_bottom.png",
